// Elementos DOM
export const $catalogMovie = document.getElementById('movie-catalog');
export const $catalogTv = document.getElementById('tv-catalog');
export const $searchInput = document.getElementById('search-input');
export const $searchButton = document.getElementById('search-button');
export const $mediaTypeFilter = document.getElementById('media-type-filter');
...
export const $prevTvBtn = document.getElementById('prev-tv-button');
